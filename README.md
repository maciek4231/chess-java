...
- aby zainstalować klienta *oraz* serwer: `sh ./tools/install_server_and_client.sh` - skrypt wymaga uprawnień superużytkownika, ponieważ instaluje mysql-server, oraz tworzy na nim bazę chess_db i konto admin
